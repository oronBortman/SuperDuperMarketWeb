...
const ID_OF_CHAT_AREA = "chatarea";
const ID_OF_CHAT_FORM = "chatform";
...
function appendChatEntry(index, entry){
    ...
    $("#" + ID_OF_CHAT_AREA).append(entryElement).append("<br>");
}
...
$(function() { // onload...do
    ...
    $("#" + ID_OF_CHAT_FORM).submit(function() {
        $.ajax({
            data: $(this).serialize(),
            url: this.action,
            timeout: 2000,
...
export function triggerAjaxChatContent() {
